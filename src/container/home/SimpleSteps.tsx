...
const SimpleSteps = () => {
  return (
    <div className="bg-[#1F1B17] py-[60px] md:py-[120px] simple-section">
      <div className="custom-continer-inner flex flex-col">
        <div className="text-center mb-8 md:mb-14">
          <h2 className="lg:text-[45px] text-3xl text-[#FFFFFF]">
            3 Simple Steps
          </h2>
          <p className="text-lg mt-3 md:mt-7 text-[#D2D2D2]">To Active Your eSims</p>
        </div>
        <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-16  md:gap-0">
