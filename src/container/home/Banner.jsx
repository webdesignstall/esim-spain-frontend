...
const Banner = () => {
  return (
    <header className="custom-continer-fuller banner-section flex flex-col lg:justify-start justify-center lg:items-start items-center gap-3 py-2 2xl:p-20 sm:p-5">
      <p>
      ...
      <h1
          ...
          className="text-white  lg:text-6xl text-2xl text-center md:text-left font-bold my-2 md:my-5">
